...
class paynl_riverty extends paynl
{
    function paynl_riverty()
    {
        parent::__construct(
            ...
            defined('MODULE_PAYMENT_PAYNL_RIVERTY_ORDER_STATUS_ID') && ((int)MODULE_PAYMENT_PAYNL_RIVERTY_ORDER_STATUS_ID > 0) ? (int)MODULE_PAYMENT_PAYNL_RIVERTY_ORDER_STATUS_ID : 0,
